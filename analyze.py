...
max_features = 5000
filename = "data/www.cs.cmu.edu.csv"

def write_json(filename, sim_dict):
...
for idvv in db:
  ...
  txt_path = os.path.join('data', 'txt', idvv) + '.txt'
